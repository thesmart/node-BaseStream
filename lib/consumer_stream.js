 ...
 * @return {self} chain
 */
ConsumerStream.prototype.setDataHandler = function(fn) {
	this._dataHandlerFn = fn;
	return this;
};
...
ConsumerStream.prototype.write = function(data) {
	...
	if (this._dataHandlerFn) {
		this._dataHandlerFn.call(this, data, this._onDataConsumed.bind(this));
	} else {
		this._onDataConsumed(null, data);
	}
 ...
 * @private
 */
ConsumerStream.prototype._onDataConsumed = function(err, result) {
	--this.countPending;
